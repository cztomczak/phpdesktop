...
is no new API / framework to learn. The process of turning an existing
...
1. Watch the project with the "Releases only" option checked
2. Subscribe to the [RSS/Atom feed](https://github.com/cztomczak/phpdesktop/releases.atom)
