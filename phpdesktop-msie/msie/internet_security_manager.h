...
public:
    ...
    HRESULT STDMETHODCALLTYPE MapUrlToZone(LPCWSTR pwszUrl, DWORD *pdwZone, DWORD dwFlags)
    {
        ...
        // dla wszystkich, to od razu wyskoczy b³¹d, ¿e nie mo¿e utworzyæ obiektu automatyzacji WScript.Shell,
        // je¿eli ustawimy 0, a w ProcessUrlAction damy return INET_E_DEFAULT_ACTION to siê pojawi komunikat
        // o bezpieczeñstwie.
    ...
    {
        // Gdy zwracamy INET_E_DEFAULT_ACTION w ProcessUrlAction() to mo¿e byæ
        // uruchomione QueryCustomPolicy(). Gdy daliœmy *pPolicy = URLPOLICY_ALLOW
        // dla wszystkich to ta funkcja nigdy nie jest wywo³ywana, ale dla
        // pewnoœci zwróæmy i tak INET_E_DEFAULT_ACTION a nie "not implemented".
